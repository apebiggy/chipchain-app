...
function LeaderRow({ entry, isYou, isPinned = false }: { entry: LeaderEntry; isYou: boolean; isPinned?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <span style={S.wraps}>{entry.wrap_count ?? 0} 📰</span>
      <span style={S.chip}>
  ...
  return (
    <div style={S.container}>
      ...
      <div style={S.colHeaders}>
        ...
        <span style={{ width: 64, textAlign: 'right' }}>Wraps</span>
...
const S: Record<string, React.CSSProperties> = {
  ...
  wraps:      { width: 64, textAlign: 'right' as const, color: '#888', fontSize: 12, fontWeight: 700, flexShrink: 0 },
