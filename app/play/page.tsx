      ...
      {activeTab === 'profile' && (
        ...
        <div style={{ background:'#fff', border:'3px solid #111', borderRadius:12, overflow:'hidden' }}>
          ...
          <div style={{ padding:16 }}>
            ...
            {/* FLEX on X */}
            {(() => {
              const flexUrl = `${process.env.NEXT_PUBLIC_URL || 'https://chipchain.shop'}/flex?chip=${profile.chipBalance}&served=${profile.totalServed}&multiplier=${profile.hasMultiplier ? '1' : '0'}&t=${profile.totalServed % 4}`
